...
export default function HomePopup() {
    ...
    return (
        <div className="k64_popup-outer">
            <div className="k64_popup">
                <div className="k64_popup-gears">
                ...
                <div className="k64_popup-text">
                    <p>Zde budou nové stránky šachového klubu TJ Kobylisy.</p>
                    <p>Pokud hledáte informace o klubu, zde je odkaz na stávající web: <a href="http://sachkobylisy.com">sachkobylisy.com</a></p>
                </div>
                <span className="k64_popup-close_btn" onClick={handlePopupClick}>x</span>
            </div>
        </div>
    );
}